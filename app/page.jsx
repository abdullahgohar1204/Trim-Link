      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-12 text-sm">
          <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-4">
            ...
            <div className="text-gray-500 text-xs mt-1">Instant link generation</div>
          </div>
          <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-4">
            <div className="font-medium text-white">🔗 Short</div>
            <div className="text-gray-500 text-xs mt-1">Clean, memorable links</div>
          </div>
          <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-4">
            <div className="font-medium text-white">🆓 Free</div>
            <div className="text-gray-500 text-xs mt-1">No sign-up required</div>
          </div>
        </div>
      </div>
    </div>
